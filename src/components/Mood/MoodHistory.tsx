...
import { Frown, Meh, Smile, Frown as FrownOpen } from 'lucide-react';

const moodConfig = {
  great: { icon: <Smile className="w-6 h-6" />, color: 'text-green-600' },
  ...
  awful: { icon: <FrownOpen className="w-6 h-6" />, color: 'text-red-600' },
};
